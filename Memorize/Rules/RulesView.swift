...
//                        .aspectRatio(contentMode: .fill)
                ...
                VStack(spacing: 30) {
                    RoundedRectangle(cornerRadius: 25).frame(height: 200).opacity(0.3)
                        .overlay(Text("Классическая игра «Мэмори» или «Найди пару!» — направлена на эффективное развитие способности к запоминанию и концентрации внимания.").foregroundColor(.white).padding())
                    RoundedRectangle(cornerRadius: 25).frame(height: 200).opacity(0.3)
